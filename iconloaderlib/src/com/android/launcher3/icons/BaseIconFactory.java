...
public class BaseIconFactory implements AutoCloseable {
    ...
    private Boolean IS_LOW_RAM =SystemProperties.getBoolean("ro.config.low_ram", false);
    ...
    protected Bitmap createIconBitmap(@Nullable final Drawable icon, final float scale,
        ...
        switch (bitmapGenerationMode) {
            ...
            default:
                bitmap = Bitmap.createBitmap(size, size, (IS_LOW_RAM? Config.ARGB_4444 : Config.ARGB_8888));
                break;
        }
        if (icon == null) {
            return bitmap;

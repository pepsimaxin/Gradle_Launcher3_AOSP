...
public class ClockDrawableWrapper extends AdaptiveIconDrawable implements BitmapInfo.Extender {
    ...
    //hct add apply theme clock
    public Drawable getClockDrawable(Context mContext,AdaptiveIconDrawable background){
        ...
        try {
            return mThemePkgContext.getResources().getDrawable(mThemePkgContext.getResources().getIdentifier("ic_app_pack_pattern", "drawable", mThemePkgName));
        } catch (Resources.NotFoundException e) {
            return background;
        }
    
    }
    //hct add apply theme clock end
    @Override
    public ClockBitmapInfo getExtendedInfo(Bitmap bitmap, int color,
		...
		//*/add apply theme clock 		
        Bitmap flattenBG = iconFactory.createScaledBitmap(getClockDrawable(iconFactory.mContext,background),
